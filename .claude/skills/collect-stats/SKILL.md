---
name: collect-stats
description: X Analytics と note ダッシュボードをブラウザ操作でデータ収集し、x-performance.md / note-performance.md / Notion を自動更新する。
user-invocable: true
allowed-tools: mcp__claude-in-chrome__tabs_context_mcp, mcp__claude-in-chrome__tabs_create_mcp, mcp__claude-in-chrome__navigate, mcp__claude-in-chrome__get_page_text, mcp__claude-in-chrome__javascript_tool, mcp__claude-in-chrome__read_page, mcp__claude-in-chrome__computer, Read, Write, Edit, mcp__notion__notion-fetch, mcp__notion__notion-update-page
---

# /collect-stats

X Analytics と note ダッシュボードをブラウザ操作でデータ収集する。
